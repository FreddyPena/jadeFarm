...
public class VwClasArticulo extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbElements = new com.js.swing.table.JTableJS<InvClasificacion>();
        ...
        jXHeader1.setDescription("Registro y consulta de Clasificación Articulo");
        ...
        jXHeader1.setTitle("Registro Clasificación Articulo");
    ...
    private com.js.swing.table.JTableJS<InvClasificacion> tbElements;
    // End of variables declaration//GEN-END:variables
    private InvClasificacion element;
    ...
    private void initComp() {
        ...
        tbElements.doLayout();
        tbElements.setModelJS(new ModelClasArticulo());
    ...
    private void delete() {
        if (this.element != null) {
            ...
            try {
                FactoryObject.getInstance().getClasArticuloController().delete(this.element.getCodigo());
    ...
    private void setElements() {
        Runnable run = new Runnable() {
            ...
            public void run() {
                ...
                try {
                    tbElements.setElements(FactoryObject.getInstance().getClasArticuloController().findAll());
                } catch (BussinessException ex) {
    ...
    private void save() {
        ...
        InvClasificacion copyElement = this.element;
        if (this.element == null) {
            this.element = new InvClasificacion();
        }
        ...
        try {
            FactoryObject.getInstance().getClasArticuloController().saveOrUpdate(this.element);
        } catch (BussinessException ex) {
    ...
    private void setElement(InvClasificacion element) {
        if (element != null) {
