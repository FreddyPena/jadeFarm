...
import com.js.inv.tablesmodel.ModelFamilia;
 ...
 * @author JADESOFT
 */
public class VwFamilia extends javax.swing.JDialog {

    public VwFamilia(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public VwFamilia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(parent);
        initComp();
    ...
    private void initComponents() {
        ...
        tbElements = new com.js.swing.table.JTableJS<InvFamilia>();
    ...
    public static void main(String[] args) {
        ...
        new VwFamilia((JDialog) null, true).setVisible(true);
    ...
    private com.js.swing.table.JTableJS<InvFamilia> tbElements;
    // End of variables declaration//GEN-END:variables
    private InvFamilia element;
    ...
    private void initComp() {
        ...
        tbElements.doLayout();
        tbElements.setModelJS(new ModelFamilia());
    ...
    private void delete() {
        if (this.element != null) {
            ...
            try {
                FactoryObject.getInstance().getFamiliaController().delete(this.element.getCodigo());
            } catch (BussinessException ex) {
                JOptionPane.showMessageDialog(this, "Error al intentar borrar este regsitro", "ERROR",
                        JOptionPane.ERROR_MESSAGE);
                Logger.getLogger(VwFamilia.class.getName()).log(Level.SEVERE, null, ex);
                return;
            }
            change = true;
    ...
    private void setElements() {
        Runnable run = new Runnable() {
            ...
            public void run() {
                ...
                try {
                    tbElements.setElements(FactoryObject.getInstance().getFamiliaController().findAll());
                } catch (BussinessException ex) {
    ...
    private void save() {
        ...
        InvFamilia copyElement = this.element;
        if (this.element == null) {
            this.element = new InvFamilia();
        }
        ...
        try {
            FactoryObject.getInstance().getFamiliaController().saveOrUpdate(this.element);
        } catch (BussinessException ex) {
    ...
    private void setElement(InvFamilia element) {
        if (element != null) {
