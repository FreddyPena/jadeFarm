...
import com.js.inv.tablesmodel.ModelIngrActivo;
 ...
 * @author JADESOFT
 */
public class VwIngrActivo extends javax.swing.JDialog {

    public VwIngrActivo(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public VwIngrActivo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(parent);
        initComp();
    ...
    private void initComponents() {
        ...
        tbFamilia = new com.jadesoft.jadelib.estandar.tablas.TableStandar<InvIngredienteActivo>();
        ...
        jXHeader1.setDescription("Registro y consulta de Ingrediente Activo");
    ...
    private void tbFamiliaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbFamiliaMouseClicked
        if (evt.getClickCount() == 2) {
            if (!consultation) {
                ...
                this.ingrediente = tbFamilia.getSelectedElement();
                dispose();
            }
        }
...
//        }
    ...
    public static void main(String[] args) {
        ...
        new VwIngrActivo((JDialog) null, true).setVisible(true);
    ...
    private com.jadesoft.jadelib.estandar.tablas.TableStandar<InvIngredienteActivo> tbFamilia;
    // End of variables declaration//GEN-END:variables
    private InvIngredienteActivo ingrediente;
    private Displacement<InvIngredienteActivo> displacement;
    ...
    private void initComp() {
        ...
        tbFamilia.doLayout();
        tbFamilia.setModelStandar(new ModelIngrActivo());
    ...
    private void setToolBarAndPanel(int panel, boolean b) {
        ...
        btNew.setEnabled(b);
        btEdit.setEnabled(b);
        b = jtpStandard.getSelectedIndex() == 0 && this.ingrediente != null;
    ...
    private void delete() {
        if (this.ingrediente != null) {
            ...
            try {
                FactoryObject.getInstance().getIngrActivoController().delete(this.ingrediente.getCodigo());
            } catch (BussinessException ex) {
                JOptionPane.showMessageDialog(this, "Error al intentar borrar este regsitro", "ERROR",
                        JOptionPane.ERROR_MESSAGE);
                Logger.getLogger(VwIngrActivo.class.getName()).log(Level.SEVERE, null, ex);
                return;
            }
            tbFamilia.removeElement(this.ingrediente);
            clean();
            setToolBarAndPanel(1, true);
            fireTableDataChanged();
        }
    ...
    private void setElements() {
        Runnable run = new Runnable() {
            ...
            public void run() {
                ...
                try {
                    tbFamilia.setElements(FactoryObject.getInstance().getIngrActivoController().findAll());
                } catch (BussinessException ex) {
    ...
    private void save() {
        ...
        int men = JOptionPane.showConfirmDialog(this, this.ingrediente == null ? "Desea guardar el nuevo registro?"
        ...
        InvIngredienteActivo copyElement = this.ingrediente;
        if (this.ingrediente == null) {
            this.ingrediente = new InvIngredienteActivo();
        }

        this.ingrediente.setDescripcion(jtDescripcion.getText());
        this.ingrediente.setIdentificador(jtIdentificador.getText());

        if (copyElement == null || !this.ingrediente.equals(copyElement)) {
            try {
                FactoryObject.getInstance().getIngrActivoController().saveOrUpdate(this.ingrediente);
            } catch (BussinessException ex) {
            ...
            tbFamilia.addElement(this.ingrediente);
        }
    ...
    public InvIngredienteActivo getSelected() {
