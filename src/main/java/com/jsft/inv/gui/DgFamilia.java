...
import com.jsft.inv.tablemodel.ModeloFamilia;
...
public class DgFamilia extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbFamilia = new com.jadesoft.jadelib.estandar.tablas.TableStandar<Familia>();
    ...
    private com.jadesoft.jadelib.estandar.tablas.TableStandar<Familia> tbFamilia;
    // End of variables declaration//GEN-END:variables
    private KeyEventDespachador eventDispatcher;
    private Familia familia;
    private DesplazamientoObject<Familia> objectDisplacement;
    ...
    private void save() {
        ...
        ManejoFamilia.getInstance().create(familia);
...
//        });
    ...
    private void setElement(Familia familia) {
        selectRow();
        if (familia != null) {
    ...
    private void selectRow() {
        ...
        if (familia != null) {
            ...
            if (jtpStandard.getSelectedIndex() == 1) {
                ...
                int row = 0;
                for (Familia f : tbFamilia.getElements()) {
                    if (f.equals(familia)) {
