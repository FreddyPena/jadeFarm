...
import com.jsft.inv.tablemodel.ModeloIngredienteActivo;
 ...
 * @author yiyi
 */
public class DgIngredienteActivo extends javax.swing.JDialog {

    public DgIngredienteActivo(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public DgIngredienteActivo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(parent);
        initComp();
    ...
    private void initComponents() {
        ...
        tbIngActivo = new com.jadesoft.jadelib.estandar.tablas.TableStandar<IngredienteActivo>();
        ...
        jXHeader1.setDescription("Registro y consulta del Ingrediente Activo del Producto");
        ...
        jXHeader1.setTitle("Registro Ingrediente Activo");
        ...
        jXPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jXPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jXPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(jtDescripcion, javax.swing.GroupLayout.DEFAULT_SIZE, 263, Short.MAX_VALUE)
        ...
        tbIngActivo.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tbIngActivo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbIngActivoMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tbIngActivo);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jtpStandard, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(6, 6, 6))
        );
    ...
    private void tbIngActivoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbIngActivoMouseClicked
        objectDisplacement.setLista(tbIngActivo.getElements());
        if (evt.getClickCount() == 2) {
            setElement(tbIngActivo.getSelectedElement());
            setTablePanel(0, false);
            setToolBar(false);
            editableComponent(false);
        }
    }//GEN-LAST:event_tbIngActivoMouseClicked

    private void jtFiltroKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtFiltroKeyReleased
        General.filtroTextField(cbFiltro.getSelectedItem(), jtFiltro, tbIngActivo);
    }//GEN-LAST:event_jtFiltroKeyReleased

    public static void main(String[] args) {
        new DgIngredienteActivo((JDialog) null, true).setVisible(true);
    }
    ...
    private com.jadesoft.jadelib.estandar.tablas.TableStandar<IngredienteActivo> tbIngActivo;
    // End of variables declaration//GEN-END:variables
    private KeyEventDespachador eventDispatcher;
    private IngredienteActivo ingrediente;
    private DesplazamientoObject<IngredienteActivo> objectDisplacement;
    private boolean consultation;
    private boolean changeDisplacement = true;
    

    protected void setColumnaWith(int Column, int width) {
        tbIngActivo.getColumnModel().getColumn(Column).setPreferredWidth(width);
    }
    ...
    private void initComp() {
        ...
        tbIngActivo.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        tbIngActivo.doLayout();
        tbIngActivo.setModelStandar(new ModeloIngredienteActivo());
        tbIngActivo.setElements(ManejoIngredienteActivo.getInstance().findAll());
    ...
    private void edit() {
        if (tbIngActivo.getSelectedElement() != null) {
            setDisplacement(true);
            objectDisplacement.setLista(tbIngActivo.getElements());
            setElement(tbIngActivo.getSelectedElement());
            setTablePanel(0, false);
    ...
    private void setToolBar(boolean b) {
        ...
        b = jtpStandard.getSelectedIndex() == 0 && ingrediente != null;
    ...
    private void delete() {
        if (ingrediente != null) {
            ...
            if (men == JOptionPane.YES_OPTION) {
                if (ManejoIngredienteActivo.getInstance().findDelete(ingrediente) != null) {
                    JOptionPane.showMessageDialog(null, "Existen artículos relacionados a este Ingrediente Activo. No se puede borrar!", "Aviso",
                            JOptionPane.WARNING_MESSAGE);
                    return;
                }
                ManejoIngredienteActivo.getInstance().delete(ingrediente);
            }
            clean();
            setTablePanel(0, false);
            setToolBar(false);
    ...
    private void select() {
        if (changeDisplacement) {
            objectDisplacement = new DesplazamientoObject<>(tbIngActivo.getElements());
    ...
    private void save() {
        ...
        int men = JOptionPane.showConfirmDialog(this, ingrediente == null ? "Desea guardar el nuevo registro?"
        ...
        if (ingrediente == null) {
            ingrediente = new IngredienteActivo();
        }

        ingrediente.setDescripcion(jtDescripcion.getText());
        ingrediente.setIdentificador(jtIdentificador.getText());
        ManejoIngredienteActivo.getInstance().create(ingrediente);
    ...
    public IngredienteActivo getSelected() {
        return ingrediente;
    }

    private void disposeConsultation() {
        if (consultation && ingrediente != null) {
            dispose();
        }
    }
...
//        });
    ...
    private void setElement(IngredienteActivo ingrediente) {
        selectRow();
        if (ingrediente != null) {
            this.ingrediente = ingrediente;
            jtIdentificador.setText(ingrediente.getIdentificador());
            jtDescripcion.setText(ingrediente.getDescripcion());
            editableComponent(false);
            //  objectDisplacement.setRegistroActual(ingrediente);           
        }
    }
    ...
    private void selectRow() {
        ...
        if (ingrediente != null) {
            ...
            if (jtpStandard.getSelectedIndex() == 1) {
                int row = 0;
                for (IngredienteActivo f : tbIngActivo.getElements()) {
                    if (f.equals(ingrediente)) {
                        tbIngActivo.changeSelection(row, 1, false, false);
                        return;
                    }
                    row++;
                }
        ...
        if (jtpStandard.getSelectedIndex() == 1 && tbIngActivo.getSelectedRow() == -1) {
            tbIngActivo.changeSelection(0, 1, false, false);
            objectDisplacement.setLista(tbIngActivo.getElements());
        }
    }
