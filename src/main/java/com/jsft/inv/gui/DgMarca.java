...
import com.jsft.inv.tablemodel.ModeloMarca;
 ...
 * @author yiyi
 */
public class DgMarca extends javax.swing.JDialog {

    public DgMarca(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public DgMarca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(parent);
        initComp();
    ...
    private void initComponents() {
        ...
        tbMarca = new com.jadesoft.jadelib.estandar.tablas.TableStandar<Marca>();
        ...
        jXHeader1.setDescription("Registro y consulta de Marcas");
        ...
        jXHeader1.setTitle("Registro Marca");
    ...
    private void tbMarcaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbMarcaMouseClicked
        objectDisplacement.setLista(tbMarca.getElements());
        if (evt.getClickCount() == 2) {
            setElement(tbMarca.getSelectedElement());
            if (!consultation) {
    ...
    private void jtFiltroKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtFiltroKeyReleased
        General.filtroTextField(cbFiltro.getSelectedItem(), jtFiltro, tbMarca);
    }//GEN-LAST:event_jtFiltroKeyReleased

    public static void main(String[] args) {
        new DgMarca((JDialog) null, true).setVisible(true);
    }
    ...
    private com.jadesoft.jadelib.estandar.tablas.TableStandar<Marca> tbMarca;
    // End of variables declaration//GEN-END:variables
    private KeyEventDespachador eventDispatcher;
    private Marca marca;
    private DesplazamientoObject<Marca> objectDisplacement;
    ...
    protected void setColumnaWith(int Column, int width) {
        tbMarca.getColumnModel().getColumn(Column).setPreferredWidth(width);
    }
    ...
    private void initComp() {
        ...
        tbMarca.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        tbMarca.doLayout();
        tbMarca.setModelStandar(new ModeloMarca());
        tbMarca.setElements(ManejoMarca.getInstance().findAll());
    ...
    private void edit() {
        if (tbMarca.getSelectedElement() != null) {
            setDisplacement(true);
            objectDisplacement.setLista(tbMarca.getElements());
            setElement(tbMarca.getSelectedElement());
            setTablePanel(0, false);
    ...
    private void setToolBar(boolean b) {
        ...
        b = jtpStandard.getSelectedIndex() == 0 && marca != null;
    ...
    private void delete() {
        if (marca != null) {
            ...
            if (men == JOptionPane.YES_OPTION) {
                if (ManejoMarca.getInstance().findDelete(marca) != null) {
                    JOptionPane.showMessageDialog(null, "Existen artículos relacionados a esta Marca. No se puede borrar!", "Aviso",
                            JOptionPane.WARNING_MESSAGE);
                    return;
                }
                ManejoMarca.getInstance().delete(marca);
            }
            clean();
            setTablePanel(0, false);
            setToolBar(false);
    ...
    private void select() {
        if (changeDisplacement) {
            objectDisplacement = new DesplazamientoObject<>(tbMarca.getElements());
    ...
    private void save() {
        ...
        int men = JOptionPane.showConfirmDialog(this, marca == null ? "Desea guardar el nuevo registro?"
        ...
        marca.setDescripcion(jtDescripcion.getText());
        marca.setIdentificador(jtIdentificador.getText());

        ManejoMarca.getInstance().create(marca);
...
//        });
    ...
    private void setElement(Marca marca) {
        selectRow();
        if (marca != null) {
            this.marca = marca;
            ...
            //  objectDisplacement.setRegistroActual(marca);           
        }
    }
    ...
    private void selectRow() {
        ...
        if (marca != null) {
            ...
            if (jtpStandard.getSelectedIndex() == 1) {
                ...
                int row = 0;
                for (Marca f : tbMarca.getElements()) {
                    if (f.equals(marca)) {
                        tbMarca.changeSelection(row, 1, false, false);
                        return;
                    }
                    row++;
                }
        ...
        if (jtpStandard.getSelectedIndex() == 1 && tbMarca.getSelectedRow() == -1) {
            tbMarca.changeSelection(0, 1, false, false);
            objectDisplacement.setLista(tbMarca.getElements());
            return;
        }
