...
import com.jsft.inv.tablemodel.ModeloRenglon;
...
public class DgRenglon extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbRenglon = new com.jadesoft.jadelib.estandar.tablas.TableStandar<Renglon>();
        ...
        jXHeader1.setDescription("Registro y consulta de Renglones de Artículos");
        ...
        jXHeader1.setTitle("Registro Renglón");
        ...
        tbRenglon.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tbRenglon.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbRenglonMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tbRenglon);
    ...
    private void tbRenglonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbRenglonMouseClicked
        objectDisplacement.setLista(tbRenglon.getElements());
        if (evt.getClickCount() == 2) {
            setElement(tbRenglon.getSelectedElement());
           if (!consultation) {
    ...
    }//GEN-LAST:event_tbRenglonMouseClicked

    private void jtFiltroKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtFiltroKeyReleased
        General.filtroTextField(cbFiltro.getSelectedItem(), jtFiltro, tbRenglon);
    ...
    private com.jadesoft.jadelib.estandar.tablas.TableStandar<Renglon> tbRenglon;
    // End of variables declaration//GEN-END:variables
    private KeyEventDespachador eventDispatcher;
    private Renglon renglon;
    private DesplazamientoObject<Renglon> objectDisplacement;
    ...
    protected void setColumnaWith(int Column, int width) {
        tbRenglon.getColumnModel().getColumn(Column).setPreferredWidth(width);
    }
    ...
    private void initComp() {
        ...
        tbRenglon.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        tbRenglon.doLayout();
        tbRenglon.setModelStandar(new ModeloRenglon());
        tbRenglon.setElements(ManejoRenglon.getInstance().findAll());
    ...
    private void edit() {
        if (tbRenglon.getSelectedElement() != null) {
            setDisplacement(true);
            objectDisplacement.setLista(tbRenglon.getElements());
            setElement(tbRenglon.getSelectedElement());
            setTablePanel(0, false);
    ...
    private void setToolBar(boolean b) {
        ...
        b = jtpStandard.getSelectedIndex() == 0 && renglon != null;
    ...
    private void delete() {
        if (renglon != null) {
            ...
            if (men == JOptionPane.YES_OPTION) {
                if (ManejoRenglon.getInstance().findDelete(renglon) != null) {
                    JOptionPane.showMessageDialog(null, "Existen artículos relacionados a esta Renglon. No se puede borrar!", "Aviso",
                            JOptionPane.WARNING_MESSAGE);
                    return;
                }
                ManejoRenglon.getInstance().delete(renglon);
            }
            clean();
            setTablePanel(0, false);
            setToolBar(false);
    ...
    private void select() {
        if (changeDisplacement) {
            objectDisplacement = new DesplazamientoObject<>(tbRenglon.getElements());
    ...
    private void save() {
        ...
        int men = JOptionPane.showConfirmDialog(this, renglon == null ? "Desea guardar el nuevo registro?"
        ...
        renglon.setDescripcion(jtDescripcion.getText());
        renglon.setIdentificador(jtIdentificador.getText());

        ManejoRenglon.getInstance().create(renglon);
    ...
    public Renglon getSelected() {
        return renglon;
    }

    private void disposeConsultation() {
        if (consultation && renglon != null) {
            dispose();
        }
    }
...
//        });
    ...
    private void setElement(Renglon renglon) {
        selectRow();
        if (renglon != null) {
            ...
            //  objectDisplacement.setRegistroActual(renglon);           
        }
    }
    ...
    private void selectRow() {
        ...
        if (renglon != null) {
            ...
            if (jtpStandard.getSelectedIndex() == 1) {
                ...
                int row = 0;
                for (Renglon f : tbRenglon.getElements()) {
                    if (f.equals(renglon)) {
                        tbRenglon.changeSelection(row, 1, false, false);
                        return;
                    }
                    row++;
                }
        ...
        if (jtpStandard.getSelectedIndex() == 1 && tbRenglon.getSelectedRow() == -1) {
            tbRenglon.changeSelection(0, 1, false, false);
            objectDisplacement.setLista(tbRenglon.getElements());
            return;
        }
